...
- **From an ink! smart contract**  
  Use the [`idn-contracts`](../guides_and_tutorials/parachains/smart_contracts/ink) library.
...
- **From an ink! smart contract**  
  Using the [`idn-contracts`](../guides_and_tutorials/parachains/smart_contracts/ink) library.
