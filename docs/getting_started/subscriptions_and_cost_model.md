...
- **From an ink! smart contract**  
  Use the [`idn-contracts library`](../guides_and_tutorials/parachains/smart_contracts/ink.md).
...
- **From an ink! smart contract**  
  Using the [`idn-contracts library`](../guides_and_tutorials/parachains/smart_contracts/ink.md).
